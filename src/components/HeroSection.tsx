      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-7xl xl:text-8xl font-extrabold tracking-tight mb-6 leading-[1.1]">
            ...
            <motion.div
              ...
              className="grid grid-cols-3 max-w-md mx-auto lg:mx-0 gap-6"
            >
              {[
                ...
                <div key={i} className="text-center lg:text-left">
                  <stat.icon className="w-5 h-5 text-cyan mx-auto lg:mx-0 mb-2" />
