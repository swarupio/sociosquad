            ...
            <Tabs defaultValue="signin" className="w-full">
              <TabsList className="w-full bg-secondary rounded-xl p-1">
               ...
               <div className="space-y-3 pt-6">
                 {authError && (
                   <p className="text-destructive text-xs text-center">{authError}</p>
                 )}
                 <button
                   onClick={handleGoogleSignIn}
                   className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-secondary border border-border text-foreground text-sm font-medium hover:bg-muted transition-colors disabled:opacity-50"
