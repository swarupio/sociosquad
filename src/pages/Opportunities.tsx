...
const hardcodedOpps = [
  { id: "h1", title: "Versova Beach Cleanup", org: "Clean Coast Mumbai", location: "Versova Beach, Andheri West, Mumbai", category: "Environment", spots: 30, date: "Oct 20", timeLabel: "2 hrs", timeHours: 2, tags: ["Environment", "Outdoor"], urgency: "High" },
  { id: "h2", title: "Tech Literacy for Kids", org: "Future India Foundation", location: "Indiranagar, Bangalore", category: "Education", spots: 15, date: "Oct 22", timeLabel: "1 hr", timeHours: 1, tags: ["Education", "Tech"], urgency: "Medium" },
  { id: "h3", title: "Stray Animal Feeding Drive", org: "Paws of Delhi", location: "Hauz Khas Village, New Delhi", category: "Humanitarian", spots: 20, date: "Oct 25", timeLabel: "3 hrs", timeHours: 3, tags: ["Animals", "Community"], urgency: "High" },
  { id: "h4", title: "Urban Tree Plantation", org: "Green Yatra", location: "Viman Nagar, Pune", category: "Environment", spots: 25, date: "Oct 28", timeLabel: "4 hrs", timeHours: 4, tags: ["Environment", "Climate"], urgency: "Medium" },
  { id: "h5", title: "Food Distribution for Seniors", org: "Robin Hood Army", location: "Salt Lake City, Kolkata", category: "Healthcare", spots: 12, date: "Oct 30", timeLabel: "2 hrs", timeHours: 2, tags: ["Community", "Food"], urgency: "High" },
  { id: "h6", title: "Blood Donation Camp", org: "Helping Hands", location: "DBIT Mumbai", category: "Healthcare", spots: 20, date: "Oct 18", timeLabel: "1 hr", timeHours: 1, tags: ["Healthcare", "Community"], urgency: "High" },
];
